    ...
    return (
        ...
        >
            <label
                ...
                onDrop={handleDrop}
                className={`border-primary group relative flex min-h-[280px] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-3xl border-2 border-dashed transition-all duration-300 md:min-h-80 ${isDragActive
